...
// GetInitParameters of this EmrCluster
func (tr *EmrCluster) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this EmrCluster using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *EmrCluster) LateInitialize(attrs []byte) (bool, error) {
	params := &EmrClusterParameters{}

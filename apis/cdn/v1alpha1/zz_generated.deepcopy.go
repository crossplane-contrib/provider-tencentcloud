...
func (in *CacheKeyParameters) DeepCopyInto(out *CacheKeyParameters) {
	*out = *in
	...
	if in.KeyRules != nil {
		in, out := &in.KeyRules, &out.KeyRules
		*out = make([]KeyRulesParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.QueryString != nil {
		...
		*out = make([]CacheKeyQueryStringParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CacheKeyQueryStringObservation) DeepCopyInto(out *CacheKeyQueryStringObservation) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CacheKeyQueryStringObservation.
func (in *CacheKeyQueryStringObservation) DeepCopy() *CacheKeyQueryStringObservation {
	if in == nil {
		return nil
	}
	out := new(CacheKeyQueryStringObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CacheKeyQueryStringParameters) DeepCopyInto(out *CacheKeyQueryStringParameters) {
	*out = *in
	if in.Action != nil {
...
func (in *CacheKeyQueryStringParameters) DeepCopy() *CacheKeyQueryStringParameters {
	if in == nil {
		return nil
	}
	out := new(CacheKeyQueryStringParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RuleCacheParameters) DeepCopyInto(out *RuleCacheParameters) {
	*out = *in
	...
	if in.HeuristicCacheSwitch != nil {
		in, out := &in.HeuristicCacheSwitch, &out.HeuristicCacheSwitch
		*out = new(string)
		**out = **in
	}
	if in.HeuristicCacheTime != nil {
		in, out := &in.HeuristicCacheTime, &out.HeuristicCacheTime
		*out = new(float64)
		**out = **in
	}

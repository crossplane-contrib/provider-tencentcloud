...
func (tr *Domain) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"aws_private_access[*].access_key": "spec.forProvider.awsPrivateAccess[*].accessKeySecretRef", "aws_private_access[*].secret_key": "spec.forProvider.awsPrivateAccess[*].secretKeySecretRef", "hw_private_access[*].access_key": "spec.forProvider.hwPrivateAccess[*].accessKeySecretRef", "hw_private_access[*].secret_key": "spec.forProvider.hwPrivateAccess[*].secretKeySecretRef", "oss_private_access[*].access_key": "spec.forProvider.ossPrivateAccess[*].accessKeySecretRef", "oss_private_access[*].secret_key": "spec.forProvider.ossPrivateAccess[*].secretKeySecretRef", "qn_private_access[*].access_key": "spec.forProvider.qnPrivateAccess[*].accessKeySecretRef", "qn_private_access[*].secret_key": "spec.forProvider.qnPrivateAccess[*].secretKeySecretRef"}
}
...
func (mg *UrlPurge) GetTerraformResourceType() string {
	return "tencentcloud_cdn_url_purge"
}
...
// LateInitialize this UrlPurge using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *UrlPurge) LateInitialize(attrs []byte) (bool, error) {
	params := &UrlPurgeParameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
...
func (mg *UrlPush) GetTerraformResourceType() string {
	return "tencentcloud_cdn_url_push"
}
...
// LateInitialize this UrlPush using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *UrlPush) LateInitialize(attrs []byte) (bool, error) {
	params := &UrlPushParameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}

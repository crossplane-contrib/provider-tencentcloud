...
func (mg *BackupConfig) GetTerraformResourceType() string {
	return "tencentcloud_redis_backup_config"
}
...
// GetInitParameters of this BackupConfig
func (tr *BackupConfig) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this BackupConfig using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *BackupConfig) LateInitialize(attrs []byte) (bool, error) {
	params := &BackupConfigParameters{}

...
func (mg *Account) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		CurrentValue: reference.FromPtrValue(mg.Spec.ForProvider.MySQLID),
		Extract:      reference.ExternalName(),
		Reference:    mg.Spec.ForProvider.MySQLIDRef,
		Selector:     mg.Spec.ForProvider.MySQLIDSelector,
		To: reference.To{
			List:    &InstanceList{},
			Managed: &Instance{},
		},
	...
	if err != nil {
		return errors.Wrap(err, "mg.Spec.ForProvider.MySQLID")
	}
	mg.Spec.ForProvider.MySQLID = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.ForProvider.MySQLIDRef = rsp.ResolvedReference

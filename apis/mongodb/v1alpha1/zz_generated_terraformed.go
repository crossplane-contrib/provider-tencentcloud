...
func (mg *Instance) GetTerraformResourceType() string {
	return "tencentcloud_mongodb_instance"
}
...
func (mg *ShardingInstance) GetTerraformResourceType() string {
	return "tencentcloud_mongodb_sharding_instance"
}
...
func (mg *StandbyInstance) GetTerraformResourceType() string {
	return "tencentcloud_mongodb_standby_instance"
}
...
// LateInitialize this StandbyInstance using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *StandbyInstance) LateInitialize(attrs []byte) (bool, error) {
	params := &StandbyInstanceParameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}

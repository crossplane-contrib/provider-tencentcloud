...
func (mg *TaskSet) GetTerraformResourceType() string {
	return "tencentcloud_cat_task_set"
}
...
func (tr *TaskSet) GetObservation() (map[string]interface{}, error) {
...
func (tr *TaskSet) SetObservation(obs map[string]interface{}) error {
...
func (tr *TaskSet) GetParameters() (map[string]interface{}, error) {
...
func (tr *TaskSet) SetParameters(params map[string]interface{}) error {
